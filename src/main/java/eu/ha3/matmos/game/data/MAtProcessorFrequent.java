...
public class MAtProcessorFrequent extends MAtProcessorModel
{
	...
	protected void doProcess()
	{
		...
		boolean mouseOverATile =
			mc.objectMouseOver != null && mc.objectMouseOver.isBlock();
		...
		for (Integer index : getRequired())
		{
			...
			case 7:
				// Get if It's Raining
				setValue(7, w.getRainStrength(0) > 0 ? 1 : 0);
				break;
			
			case 8:
				// Get if It's Thundering (regardless of rain)
				setValue(8, w.getWeightedThunderStrength(0) > 0 ? 1 : 0);
				break;
			...
			case 32:
				setValue(32, player.inventory.getCurrentItemStack() != null ? player.inventory.getCurrentItemStack().itemID : -1);
			...
			case 50:
				setValue(50, MathHelper.ceiling_float_int(player.getTotalProtection(null)));
				break;
			
			case 51:
				setValue(51, MAtAccessors.getFoodStatsOf(player).getNutrition()); //(getFoodStats())
				break;
			
			case 52:
				setValue(52, MAtAccessors.getFoodStatsOf(player).getSatiation() * 1000); //(getFoodStats())
				break;
			...
			case 54:
				setValue(54, (player.experience * 1000));
				break;
			
			case 55:
				setValue(55, player.getExperienceLevel());
				break;
			
			case 56:
				setValue(56, player.getExperienceValue());
				break;
			...
			case 62:
				setValue(62, player.inventory.getCurrentItemStack() == null ? -1 : player.inventory
					.getCurrentItemStack().getItemDamage());
				break;
			...
			case 86:
				setValue(
					86,
					mouseOverATile ? mc.objectMouseOver.getBlockHitID() : 0);
				break;
			
			case 87:
				setValue(
					87,
					mouseOverATile ? mc.objectMouseOver.block_hit_metadata : 0);
				break;
